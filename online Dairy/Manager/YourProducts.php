...
include('DatabaseConnection.php');
  ...
  $companyName=$_POST['companyName'];
      ...
      mysqli_query($con,"update addProduct set  productName='$productName', quantity='$quantity', catagory='$catagory',companyName=
        '$companyName'  where productId='$productId' ");
...
$man_ID=mysqli_query($con,"select id from manager where username='$username' and password='$password'");
